        ...
        <div class="main-navbar">
            ...
            <div id="mainnav">
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title {{ prefixActive('/page-layout') }}" href="javascript:void(0)"><i data-feather="layout"></i><span>Page layout</span></a>
                        <ul class="nav-submenu menu-content"  style="display: {{ prefixBlock('/page-layout') }};">
                            <li><a href="{{ route('boxed-layout') }}" class="{{routeActive('boxed-layout')}}">Boxed</a></li>
                            <li><a href="{{ route('layout-rtl') }}" class="{{routeActive('layout-rtl')}}">RTL</a></li>
                            <li><a href="{{ route('layout-dark') }}" class="{{routeActive('layout-dark')}}">Dark</a></li>
                            <li><a href="{{ route('footer-light') }}" class="{{routeActive('footer-light')}}">Footer Light</a></li>
                            <li><a href="{{ route('footer-dark') }}" class="{{routeActive('footer-dark')}}">Footer Dark</a></li>
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title {{ prefixActive('/knowledgebase') }}" href="javascript:void(0)"><i data-feather="database"></i><span>Knowledgebase</span></a>
                        <ul class="nav-submenu menu-content" style="display: {{ prefixBlock('/knowledgebase') }};">
                            <li><a href="{{ route('knowledgebase') }}" class="{{routeActive('knowledgebase')}}">Knowledgebase</a></li>
                            <li><a href="{{ route('knowledge-category') }}" class="{{routeActive('knowledge-category')}}">Knowledge category</a></li>
                            <li><a href="{{ route('knowledge-detail') }}" class="{{routeActive('knowledge-detail')}}">Knowledge detail</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="nav-link menu-title link-nav {{ routeActive('support-ticket') }}" href="{{ route('support-ticket') }}"><i data-feather="headphones"></i><span>Support Ticket</span></a>
                    </li>
                </ul>
            </div>
