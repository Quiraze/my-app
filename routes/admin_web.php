...
Route::prefix('page-layout')->group(function () {
	Route::view('boxed-layout', 'admin.page-layout.boxed')->name('boxed-layout');
	Route::view('layout-rtl', 'admin.page-layout.rtl')->name('layout-rtl');
	Route::view('layout-dark', 'admin.page-layout.dark')->name('layout-dark');
...
Route::prefix('knowledgebase')->group( function(){
	Route::view('', 'admin.miscellaneous.knowledgebase')->name('knowledgebase');
	Route::view('knowledge-category', 'admin.miscellaneous.knowledge-category')->name('knowledge-category');
	Route::view('knowledge-detail', 'admin.miscellaneous.knowledge-detail')->name('knowledge-detail');
});
Route::view('support-ticket', 'admin.miscellaneous.support-ticket')->name('support-ticket');
